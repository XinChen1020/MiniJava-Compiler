 ...
 */
  ...
  * Team: Xin Chen
  */
public class SymbolTableVisitorModified implements Visitor {

  public SymbolTableModified symbolTable = new SymbolTableModified();
  ...
  public Object visit(Formal node, Object data){ 
      ...
      return getTypeName(node.t); 
  }

  public Object visit(FormalList node, Object data){ 
      Formal f=node.f;
      FormalList flist=node.flist;
      String parameter_type = (String) node.f.accept(this, data);
      String parameter_type_rest = "";
      if (node.flist != null) {
        parameter_type_rest = (String) node.flist.accept(this, data);
        return parameter_type_rest + " " + parameter_type; 
  ...
  public Object visit(MethodDecl node, Object data){ 
      ...
      if(f != null){
          parameter_list = (String) node.f.accept(this, data2);
      }
